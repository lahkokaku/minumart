<x-user title="User Dashboard">
    ...
    <div class="container my-5 pt-5">
        <h2 class="my-3 fw-light" style="font-family: 'Roboto">Welcome Back, <span class="text-gr-b3-b4 fw-bold fs-2" style="font-family: 'Lexend';">{{ Auth::guard('web')->user()->name }}</span> 👋</h2>
