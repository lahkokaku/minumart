<x-admin title="User Dashboard">
    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            <ul class="nav nav-tabs d-flex align-items-center border border-0 w-100 justify-content-center" id="myTab"
                role="tablist">
                <li class="nav-item">
                ...
                <hr class="connector ">
                <li class="nav-item">
                    <button class="step {{ $transactionHeader->status == 2 ? 'active' : 'disabled' }}" id="profile-tab"
                ...
                <li class="nav-item">
                    <button class="step    {{ $transactionHeader->status == 3 ? 'active' : 'disabled' }}"
                        id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab"> 3
                    </button>
                </li>
                <hr class="connector ">

                <li class="nav-item">
                    <button class="step {{ $transactionHeader->status == 4 ? 'active' : 'disabled' }}" id="contact-tab"
                        data-bs-toggle="tab" data-bs-target="#step-4" type="button" role="tab"> 4 </button>
                </li>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade {{ $transactionHeader->status == 2 ? 'active show' : '' }}" id="profile"
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="col-12 col-md-8 text-center">
                        <x-card>
                            <img src="/storage/assets/making_order.webp" class="img-fluid w-50  " alt="making_order">
            ...
            <div class="tab-pane fade {{ $transactionHeader->status == 4 ? 'active show' : '' }}" id="step-4"
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="col-12 col-md-8 text-center">
                        <x-card>
                            <img src="/storage/assets/order-confirmed.png" class="img-fluid w-50 h-50" alt="making_order">
                            <h3 class="fw-bold text-capitalize"> Your order has been picked up. Enjoy your order </h3>
                        ...
                        @foreach ($transactionHeader->transactionDetail as $transactionDetail)
                            ...
                            <div
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p>Total</p>
                                        <p>Rp {{ number_format($beverage->price * $transactionDetail->quantity) }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
