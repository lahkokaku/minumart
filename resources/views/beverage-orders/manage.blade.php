                    ...
                    @foreach ($pendingTransactions as $pendingTransaction)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-4"> 
                                <form  action={{ route('beverage-orders.update-status-admin', $pendingTransaction->id) }} method="POST">
                                    @csrf
                                    @method('PUT')
                ...
                <table class="table table-striped table-bordered" id="dataTables">
                    ...
                    @foreach ($makingTransactions as $makingTransaction)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-4"> 
                                <form  action={{ route('beverage-orders.update-status-admin', $makingTransaction->id) }} method="POST">
                                    @csrf
                                    @method('PUT')
                ...
                <table class="table table-striped table-bordered" id="dataTables">
                    ...
                    @foreach ($readyTransactions as $readyTransaction)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-4"> 
                                <form  action={{ route('beverage-orders.update-status-admin', $readyTransaction->id) }} method="POST">
                                    @csrf
                                    @method('PUT')
