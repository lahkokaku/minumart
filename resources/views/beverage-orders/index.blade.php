<x-guest title="Beverage Catalog">
    <div class="container " style="margin-top: 80px">
                ...
                <div class="col-md-4">
                    <x-card-beverage>
                        ...
                        <div class="p-4">
                            ...
                            <button class="btn btn-primary add-to-cart" data-id="{{ $beverage->id }}"
        ...
        <div class="cart position-fixed  " style="right:10px; top:70px;" id="cart">
            <button type="button" class="btn btn-primary">
                Carts <span class="ms-1 badge bg-light text-dark" id="cart-length">0</span>
            </button></h1>
        </div>

        <div class="position-fixed bg-white p-4 shadow-sm rounded d-none" style="right:20px; top:50px;"
            id="cart-detail">
            <table class="table">
                <thead>
                    <tr>
